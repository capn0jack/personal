...
$apiKey = '806f3861ca49533f2411901b0b1dcc550087d5c3'
# $pass = 'X'
# $pair = "Authorization: $($apiKey)"
# $id = '60a6cc4cdca0fd46b9357837'
$uriBase = 'https://api.sparkpost.com/api/v1'
$uriListArticlesByCollection = "$uriBase/collections/$id/articles"
$uriBaseArticle = "$uriBase/articles"
...
# https://api.sparkpost.com/api/v1/message-events?bounce_classes=1&delimiter=,&events=delivery,injection,bounce,delay,policy_rejection,out_of_band,open,click,generation_failure,generation_rejection,spam_complaint,list_unsubscribe,link_unsubscribe&page=25&per_page=1000
# &campaign_ids=Example%20Campaign%20Name

# &friendly_froms=sender@mail.example.com
# &from=2018-01-01T00:00
# &message_ids=0e0d94b7-9085-4e3c-ab30-e3f2cd9c273e
# &reason=bounce
# &recipients=recipient@example.com
# &template_ids=templ-1234&timezone=America/New_York
# &to=2018-12-31T23:59
# &transmission_ids=65832150921904138


$results = Invoke-WebRequest -Headers $Headers -Uri "https://api.sparkpost.com/api/v1/events/message?per_page=1000&cursor=initial"
#message-events?&from=2021-06-18T00:00&to=2021-06-18T23:59"
#?bounce_classes=1&delimiter=,&events=delivery,injection,bounce,delay,policy_rejection,out_of_band,open,click,generation_failure,generation_rejection,spam_complaint,list_unsubscribe,link_unsubscribe&page=25&per_page=1000"
# $content.GetType()
# $content | Get-Member
